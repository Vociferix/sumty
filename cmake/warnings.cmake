...
if(MSVC)
    target_compile_options(${PROJECT_NAME}-warnings INTERFACE ${MSVC_WARNINGS})
elseif(CMAKE_CXX_COMPILER_ID MATCHES ".*Clang")
    target_compile_options(${PROJECT_NAME}-warnings INTERFACE ${CLANG_WARNINGS})
elseif(CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
    target_compile_options(${PROJECT_NAME}-warnings INTERFACE ${GCC_WARNINGS})
endif()
